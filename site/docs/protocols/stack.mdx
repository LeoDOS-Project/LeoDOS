...
export const Proto = ({name, origin}) => {
...
<Layer name="Application">
  <div style={{display: 'flex', gap: 4}}>
    <Proto name="SpaceCoMP" origin="leodos" /><Proto name="ColonyOS" origin="leodos" />
  </div>
</Layer>
<Layer name="Transport">
  <div style={{display: 'flex', gap: 4}}>
    <Proto name="SRSPP" origin="leodos" /><Proto name="CFDP" />
  </div>
</Layer>
<Layer name="Network">
  <Group name="Routing">
    <Proto name="ISL Router" origin="leodos" /><Proto name="PassThrough" origin="leodos" /><Proto name="Gossip" origin="leodos" />
  </Group>
</Layer>
<Layer name="Data Link">
  ...
  <Group name="Transfer Frame">
    <Proto name="TM" /><Proto name="TC" /><Proto name="AOS" /><Proto name="Proximity-1" /><Proto name="USLP" />
  </Group>
  <Group name="Security">
    <Proto name="SDLS" />
  </Group>
...
<Layer name="Coding">
  ...
  <Group name="Forward Error Correction">
    <Proto name="RS(255,223)" /><Proto name="LDPC (AR4JA)" /><Proto name="Convolutional" />
  </Group>
  <Group name="Framing">
...
<Layer name="Physical">
  <Group name="Modulation">
    <Proto name="BPSK" /><Proto name="QPSK" /><Proto name="OQPSK" /><Proto name="8PSK" /><Proto name="GMSK" />
  </Group>
  <Group name="Hardware">
    <Proto name="UART" origin="cfs" /><Proto name="SPI" origin="cfs" /><Proto name="I2C" origin="cfs" /><Proto name="CAN" origin="cfs" /><Proto name="GPIO" origin="cfs" /><Proto name="UDP" origin="cfs" /><Proto name="TCP" origin="cfs" />
  </Group>
</Layer>
...
1. A ground station submits a *job* defining the computation to
   perform and the geographic area of interest.
2. The *coordinator* (a designated satellite or ground station)
...
3. *Collectors* gather the raw input data (e.g. from on-board
   instruments).
4. *Mappers* process their assigned data partitions.
5. *Reducers* aggregate the partial results into a final output.
6. The final result is downlinked to the ground station.
...
Quadrature PSK uses four phases (0, 90, 180, 270 degrees), carrying
