...
<Packet title="DATA Packet (13 + N bytes)">
  ...
  <Header title="SRSPP Header (3 bytes)" color="#fff8ee" border="#bba050">
    ...
    <Field name="Packet Type" bits="1 bit" desc="0 = DATA" />
    <Field name="Spare" bits="7 bits" desc="Reserved (0)" />
  </Header>
...
<Packet title="ACK Packet (17 bytes, fixed)">
  ...
  <Header title="SRSPP Header (3 bytes)" color="#fff8ee" border="#bba050">
    <Field name="Source Address" bits="16 bits" desc="Sender (orb, sat)" />
    <Field name="Packet Type" bits="1 bit" desc="1 = ACK" />
    <Field name="Spare" bits="7 bits" desc="Reserved (0)" />
  </Header>
...
- **Packet Type** — 1 bit: `0` for DATA (carries application payload), `1` for ACK (carries acknowledgment). The remaining 7 bits of the byte are reserved.
