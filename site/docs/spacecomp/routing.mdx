...
<Grid>
  ...
  <Cell /><Cell /><Cell /><Cell color="#c8daf8" border="2px solid #6688bb" /><Cell /><Cell /><Cell />
  <Cell /><Cell /><Cell color="#c8daf8" border="2px solid #6688bb" /><Cell color="#c8daf8" border="2px solid #6688bb" /><Cell color="#c8daf8" border="2px solid #6688bb" label="D" /><Cell /><Cell /><Cell />
  <Cell /><Cell color="#f5e0b0" border="2px solid #bba050" label="S" /><Cell color="#c8daf8" border="2px solid #6688bb" /><Cell /><Cell /><Cell /><Cell /><Cell />
  <Cell /><Cell /><Cell /><Cell /><Cell /><Cell /><Cell /><Cell />
  <Cell /><Cell /><Cell /><Cell /><Cell /><Cell /><Cell /><Cell />
  <Cell /><Cell /><Cell /><Cell /><Cell /><Cell /><Cell /><Cell />
  <Cell /><Cell /><Cell /><Cell /><Cell /><Cell /><Cell /><Cell />
</Grid>
<Label>Manhattan: east then north.<br/>All cross-plane hops at equator.</Label>
</div>
<div>
<Grid>
  <Cell /><Cell /><Cell /><Cell color="#d4e8d4" border="2px solid #88aa88" /><Cell color="#d4e8d4" border="2px solid #88aa88" label="D" /><Cell /><Cell /><Cell />
  <Cell /><Cell /><Cell /><Cell color="#d4e8d4" border="2px solid #88aa88" /><Cell /><Cell /><Cell /><Cell />
  <Cell /><Cell /><Cell color="#d4e8d4" border="2px solid #88aa88" /><Cell /><Cell /><Cell /><Cell /><Cell />
...
<Label>Distance-minimizing: north first,<br/>cross-plane hops near pole (shorter).</Label>
</div>
</div>

<div style={{display: 'flex', gap: 16, fontSize: '0.8em', justifyContent: 'center', marginBottom: 16}}>
  <span>↑ North (toward pole) &nbsp; ↓ South (toward equator) &nbsp; ← → Cross-plane</span>
</div>

In the Manhattan path (left), the three cross-plane hops happen at the equator where links are longest. In the distance-minimizing path (right), the satellite first moves north (toward the pole) along its own plane, then takes the cross-plane hops where the planes are closer together, then moves south to the destination. Same 5 hops — shorter total distance.
